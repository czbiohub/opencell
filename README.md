...
## Directories
 ...
 - `opencell`: this is a Python package that contains data processing methods and the backend (database and API) for the web app
 - `client`: this is the frontend of the web app
- `notebooks`: Jupyter notebooks used for development, sanity checks, figure generation, etc 
